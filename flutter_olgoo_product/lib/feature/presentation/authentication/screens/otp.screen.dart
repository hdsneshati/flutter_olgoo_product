...
import 'package:flutter_olgoo_product/config/extentions/string_extensions.dart';
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                  "کد فعالسازی به شماره ی ${widget.userPhoneNumber} ارسال شد"),
                  ...
                  onPressed: () {
                    if (_canResend) {
                      ...
                      BlocProvider.of<AuthBloc>(context).add(SendOtpEvent(
                          widget.userPhoneNumber.removeLeadingZero()));
                    }
                  },
                  child: _canResend
                      ? Text(
                      ...
                      if ((state.status as SuccessAuthStatus).user.status ==
                        ...
                        context.goNamed(
                          ...
                          extra: widget.userPhoneNumber,
                              ...
                              .status ==
                          "تعلیق شده") {
                        SnackBars.errorSnackBar(context, "دسترسی شما محدود شده",
